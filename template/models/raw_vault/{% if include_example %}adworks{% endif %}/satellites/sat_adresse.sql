{#
    Satellite: sat_adresse
    Parent Hub: hub_adresse
    Source: adworks_adresse
    Payload: AddressLine1, AddressLine2, City, StateProvince, CountryRegion, PostalCode, ModifiedDate
...
{%- set yaml_metadata -%}
source_model: "adworks_adresse"
src_pk: "hk_adresse"
src_hashdiff: 
  source_column: "hd_adresse"
  alias: "hashdiff"
src_payload: 
    - "addressline1"
    - "addressline2"
